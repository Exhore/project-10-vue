<template>
    <div v-if="isOpen"
        class="font-medium text-gray-400 hover:text-gray-400 py-3 px-4 text-sm inline-flex items-center gap-x-2 dark:text-gray-400 dark:hover:text-gray-500"
        href="#" data-hs-overlay="#hs-basic-modal">
        Log in
    </div>
