            ...
            <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
                <div class="max-w-xl lg:max-w-lg">
                    ...
                    <div class="mt-6 flex max-w-md gap-x-4 flex-wrap">
                        ...
                        <button type="submit"
                            class="flex-none rounded-md bg-blue-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500">Subscribe</button>
                ...
                <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
                    <div class="flex flex-col items-start">
                        ...
                        <dd class="mt-2 leading-7 text-gray-400">Each week you will receive an upcoming articles, reports,
                            reviews and more.</dd>
                    </div>
                    <div class="flex flex-col items-start">
                        <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                        ...
                        <dd class="mt-2 leading-7 text-gray-400">We are compromised to not spam your e-mail (not really).
                        </dd>
                    </div>
                </dl>
            </div>
